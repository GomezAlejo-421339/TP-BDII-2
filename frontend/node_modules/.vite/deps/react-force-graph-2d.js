...
function O(n2, l2, u2, t3) {
  ...
  if (null === c3 && null == e2 || a3 && e2 == c3.key && f2 == c3.type) return u2;
  if (t3 > (a3 ? 1 : 0)) {
...
function q(n2, u2, t3, i2, r2, o2, e2, f2, c3, a3) {
  ...
  else null == o2 && u2.__v == t3.__v ? (u2.__k = t3.__k, u2.__e = t3.__e) : f2 = u2.__e = G(t3.__e, u2, t3, i2, r2, o2, e2, c3, a3);
...
function G(u2, t3, i2, r2, o2, e2, f2, c3, a3) {
  ...
  if (null == x3) m3 === k2 || c3 && u2.data == k2 || (u2.data = k2);
    ...
    if (e2 = "textarea" == x3 && null != k2.defaultValue ? null : e2 && n.call(u2.childNodes), !c3 && null != e2) for (m3 = {}, s2 = 0; s2 < u2.attributes.length; s2++) m3[(y3 = u2.attributes[s2]).name] = y3.value;
    ...
    else if (p2 && (u2.innerHTML = ""), L("template" == t3.type ? u2.content : u2, g(v2) ? v2 : [v2], t3, i2, r2, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o2, e2, f2, e2 ? e2[0] : i2.__k && $(i2, 0), c3, a3), null != e2) for (s2 = e2.length; s2--; ) b(e2[s2]);
