...
// === Usuarios ===
CREATE (u1:Usuario {id: 'u1', nombre: 'UsuarioBot1', seguidores: 120, antiguedadDias: 3})
CREATE (u2:Usuario {id: 'u2', nombre: 'UsuarioBot2', seguidores: 45, antiguedadDias: 5})
CREATE (u3:Usuario {id: 'u3', nombre: 'UsuarioReal1', seguidores: 1500, antiguedadDias: 720})
CREATE (u4:Usuario {id: 'u4', nombre: 'UsuarioBot3', seguidores: 80, antiguedadDias: 2})
CREATE (u5:Usuario {id: 'u5', nombre: 'UsuarioReal2', seguidores: 3200, antiguedadDias: 1095})
CREATE (u6:Usuario {id: 'u6', nombre: 'UsuarioBot4', seguidores: 200, antiguedadDias: 10})
CREATE (u7:Usuario {id: 'u7', nombre: 'UsuarioReal3', seguidores: 890, antiguedadDias: 540})
CREATE (u8:Usuario {id: 'u8', nombre: 'UsuarioBot5', seguidores: 30, antiguedadDias: 1})
CREATE (u9:Usuario {id: 'u9', nombre: 'UsuarioBot6', seguidores: 150, antiguedadDias: 7})
CREATE (u10:Usuario {id: 'u10', nombre: 'UsuarioReal4', seguidores: 2100, antiguedadDias: 800})

// COMPARTE (difusión masiva de noticias falsas)
...
// Difusión de noticia falsa de fusión fría
...
// Comparticiones de noticias confiables (usuarios reales)
